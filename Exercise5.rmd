...
#for the individual, another one for the categorical variables; if #"quali", one color is used for each categorical variables; else if it is the position of a #categorical
